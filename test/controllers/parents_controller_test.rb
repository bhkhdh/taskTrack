...
class ParentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parent" do
    assert_difference('Parent.count') do
      post parents_url, params: { parent: { balance: @parent.balance, full_name: @parent.full_name } }
    end
  ...
  test "should update parent" do
    patch parent_url(@parent), params: { parent: { balance: @parent.balance, full_name: @parent.full_name } }
